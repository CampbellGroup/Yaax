...
class DDSChannels(EnvExperiment):
    ...
    def build(self): #This code runs on the host device
        ...
        self.setattr_argument("freq0", NumberValue(default=200*MHz, ndecimals = 7,type="float", unit="MHz"), group = "935 AOM")  
        self.setattr_argument("amp0", NumberValue(default=0.38, ndecimals = 7,type="float",max = 0.38), group = "935 AOM")  
        self.setattr_argument("attenuation0", NumberValue(type="float"), group = "935 AOM")                     
        self.setattr_argument("freq1", NumberValue(default=200*MHz, ndecimals = 7,type="float", unit="MHz"), group = "760 AOM")  
        self.setattr_argument("amp1", NumberValue(default=0.345, ndecimals = 7,type="float", max=0.345), group = "760 AOM")              
        self.setattr_argument("attenuation1", NumberValue(type="float"), group = "760 AOM")                     
